...
public class PriorityNonPreemptive {
	public Timer PriorityNonPreemptivetimer;
	...
	PriorityNonPreemptive()
	{
        ...
        public void actionPerformed(ActionEvent evt) 
        {
        	...
        	catch(Exception e)
        	{
        		...
        		Simulator.layeredPane.removeAll();
        		PriorityNonPreemptivetimer.stop();
        	}
        }
        };
        PriorityNonPreemptivetimer = new javax.swing.Timer(delay, taskPerformer);
        PriorityNonPreemptivetimer.start();
	}
}
